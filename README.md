...
**Known issue: Spotify local files do not show the cover art due to it not supporting the m4a file format. I had not realized this format is exclusive to Apple Music. I am working on creating another version of the comp with mp3 files which would support Spotify as well as any other music player. This is a lot of work for me to undertake for a platform I don't use so no ETA. **
